...
#load data
df_countries = pd.read_csv("https://github.com/DALIAALISIDDIG/Aligniverse_Gender_English/blob/main/aligniverse_gender-main/UNSD_Methodology_ancestry.csv", sep = ";")

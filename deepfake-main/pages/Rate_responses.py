...
with ((st.form(key="form_rating", clear_on_submit=True))):
    try:
     ...
     #   st.divider() 
        ...
        st.markdown('<h4>How serious a threat do you think the **issue discussed in the clip** is to the country?</h4>', unsafe_allow_html=True)
        ...
        st.markdown('<h4>To what extent did the clip make you feel that **your social or political group** was disrespected?</h4>', unsafe_allow_html=True)
